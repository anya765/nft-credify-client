    ...
    >
      {certificates.map((certificate) => (
        <li key={certificate.block_number} className="relative overflow-hidden">
          ...
          >
            <a>
              <div className="group block w-full aspect-w-10 aspect-h-7 rounded-lg bg-gray-100 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-purple-500 overflow-hidden">
