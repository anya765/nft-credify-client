...
function Certificate({ address, id }) {
  ...
  const verifyHash = async () => {
    ...
    const NFTCredify = new ethers.Contract(
      certificate.token_address,
      abi.abi,
      signer
    );
    const hash = await NFTCredify.getTokenMetadataHash(certificate.token_id);
        ...
        <div className="flex flex-col space-y-5">
          ...
          <div className="text-center">
            <button
              ...
              type="submit"
              disabled={!!error}
              className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-60 disabled:bg-gray-400 disabled:text-gray-700"
            >
              Decrypt
            </button>
            {error && (
      ...
      <div className=" flex-1 flex justify-center lg:items-center  ">
        <div className="max-w-lg w-full mx-4 lg:mx-8 my-6 lg:my-16">
          <div className="bg-slate-100 text-slate-400 rounded-full p-0.5 inline-flex">
            ...
            <span className="pl-1 pr-2 text-sm font-semibold">NFT Credify</span>
          </div>
                    ...
                    <li className="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                      ...
                      <div className="ml-4 flex-shrink-0">
                        <a
                          ...
                          className="font-medium text-nftcredify-primary hover:text-purple-500"
                        >
                          Open
                        </a>
                      </div>
